        ...
        <div class="flex min-h-full items-center justify-center p-4 text-center">
            ...
            <Transition appear enter-active-class="ease-out duration-300"
                ...
                <div v-show="isModalOpen"
                    ...
                    <form @submit.prevent="submitSuplier" class="p-6 space-y-4 font-sans">

                        <div class="space-y-1.5">
                            <label for="nama" class="text-sm font-medium text-slate-900 dark:text-slate-200 block">
                                Nama Suplier
                            </label>
                            <input v-model="formSuplier.nama" type="text" id="nama" placeholder="Nama suplier"
                        ...
                        <div class="space-y-1.5">
                            <label for="kontak" class="text-sm font-medium text-slate-900 dark:text-slate-200 block">
                                Kontak
                            </label>
                            <input v-model="formSuplier.kontak" type="text" id="kontak" placeholder="Kontak suplier"
                                class="w-full px-3.5 py-2 bg-white dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl text-sm focus:outline-none focus:border-indigo-500 dark:focus:border-indigo-600 text-slate-900 dark:text-white transition" />
                        ...
                        <div class="space-y-1.5">
                            ...
                            <textarea v-model="formSuplier.alamat" rows="2" placeholder="Masukkan alamat lengkap..."
...
const { isModalOpen, isEdit, formSuplier, errors, isLoading, submitSuplier, closeModal } = useSuplier();
</script>
