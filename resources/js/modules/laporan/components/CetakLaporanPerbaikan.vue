    ...
    <div class="min-h-screen bg-zinc-800 flex flex-col items-center justify-start p-6 print:bg-white print:p-0">
        ...
        <div v-if="isLoading" class="my-auto text-white font-semibold animate-pulse print:hidden">
            <div class="flex flex-col items-center gap-3">
                ...
                <span>Menyiapkan Laporan Perbaikan...</span>
            </div>
        </div>
            ...
            <table class="w-full border-collapse">
                ...
                <thead class="print-header">
                    ...
                    <tr
                        ...
                        <th class="w-[4%] border-r border-slate-300 py-2 text-center">
                            NO
                        </th>

                        <th class="w-[10%] border-r border-slate-300 py-2 text-center">
                            TGL MASUK
                        </th>
                        ...
                        <th class="w-[16%] border-r border-slate-300 py-2 text-center">
                            KODE TRANSAKSI
                        </th>

                        <th class="w-[13%] border-r border-slate-300 py-2 text-center">
                            KODE PRODUK
                        </th>
                        ...
                        <th class="w-[8%] border-r border-slate-300 py-2 text-center">
                            BERAT
                        </th>

                        <th class="w-[7%] border-r border-slate-300 py-2 text-center">
                            KARAT
                        </th>
                ...
                <tbody class="divide-y divide-slate-200 text-[10px]">
                    <tr v-for="(item, index) in laporanData.items" :key="index" class="break-inside-avoid">
                        ...
                        <td class="py-2 px-2 border-r border-slate-200">
                            ...
                            <div class="text-[9px] text-slate-500 normal-case">
                                {{ item.nama_produk }}
                            </div>
                        </td>
                        <td class="py-2 text-center font-mono border-r border-slate-200">
                                    ...
                                    <div class="w-[280px] space-y-1 text-[10px]">
                                        ...
                                        <!-- <div class="flex justify-between pt-0.5">
                                            ...
                                            <span
                                                ...
                                                {{ formatRupiah(laporanData.summary?.total_seluruh_harga ||
                                                laporanData.summary?.total_harga) }}
                                            </span>
                                        </div> -->
                                    </div>
...
const fetchLaporanData = async () => {
    ...
    try {
        ...
        const response = await laporanService.getLaporanPerbaikan(payload);

        if (response && response.status) {
            laporanData.value = response.laporanData;
            document.title = `LAPORAN-PERBAIKAN-${tanggalAwal}_sd_${tanggalAkhir}`;
        }
    } catch (error) {
        console.error("Gagal memuat data laporan perbaikan:", error);
    } finally {
