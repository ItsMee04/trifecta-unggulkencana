                ...
                <div v-show="isModalOpen"
                    ...
                    <div
                        ...
                        <h2 class="font-bold text-slate-900 dark:text-white text-base">
                            {{ isEdit ? 'EDIT REKENING / SALDO' : 'TAMBAH REKENING / SALDO' }}
                        </h2>
                    ...
                    <form @submit.prevent="submitSaldo" class="p-6 space-y-4 font-sans">

                        <div class="space-y-1.5">
                            <label for="nama" class="text-sm font-medium text-slate-900 dark:text-slate-200 block">
                                Nama Rekening
                            </label>
                            <input v-model="formSaldo.rekening" type="text" id="nama" placeholder="Nama suplier"
                            ...
                            <span v-if="errors.rekening" class="text-xs text-rose-500 font-medium block mt-1">
                                {{ errors.rekening }}
                            </span>
                        </div>
...
const { isModalOpen, isEdit, formSaldo, errors, isLoading, submitSaldo, closeModal } = useSaldo();
</script>
