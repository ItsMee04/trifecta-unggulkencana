            ...
            <table class="w-full text-left border-collapse min-w-[600px]">
                <thead>
                    <tr
                        ...
                        <th class="py-3 px-4 w-[55%]">Nama Role</th>
                ...
                <tbody class="divide-y divide-slate-100 dark:divide-slate-800 text-sm">
                    ...
                    <tr v-if="isLoading && paginatedRole.length === 0">
                    ...
                    <tr v-else v-for="(item, index) in paginatedRole" :key="item.id"
                        ...
                        <td class="py-3 px-4">
                            <div class="flex items-center justify-center gap-1">
                                ...
                                <button @click="handlePermission(item)" title="Set Permission"
                                    class="p-1.5 text-amber-600 dark:text-amber-400 hover:bg-amber-50 dark:hover:bg-amber-950/50 rounded-xl transition active:scale-95">
...
<script setup>
// KUNCI PERBAIKAN 1: Impor ShieldCheck di sini
import { Search, ChevronLeft, ChevronRight, ChevronsLeft, ChevronsRight, SquarePen, Trash2, RotateCw, ShieldCheck } from 'lucide-vue-next';
import { useRole } from '../composables/useRole';

// KUNCI PERBAIKAN 2: Destruktur handlePermission dari composable useRole
const {
    paginatedRole,
    searchQuery,
    currentPage,
