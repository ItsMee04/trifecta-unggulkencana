        ...
        <div
            ...
            <div class="flex items-start justify-between">
                <div>
                    ...
                    <template v-else>
                        <h2 class="mt-2 text-3xl font-bold text-blue-400 dark:text-white">{{ totalProduk }}</h2>
                        <p class="mt-3 text-xs text-slate-400">Produk aktif di inventory</p>
                    </template>
                </div>
                <div class="relative">
                    <div class="w-14 h-14 rounded-2xl bg-blue-400 flex items-center justify-center">
        ...
        <div
            ...
            <div class="flex items-start justify-between">
                <div>
                    ...
                    <SkeletonCard v-if="isLoading" />
                    <template v-else>
                        <h2 class="mt-2 text-3xl font-bold text-emerald-400 dark:text-white">{{ totalPenjualanHariIni }}</h2>
                        <p class="mt-3 text-xs text-slate-400">Penjualan hari ini</p>
                    </template>
                </div>
                <div class="w-14 h-14 rounded-2xl bg-emerald-400 flex items-center justify-center">
        ...
        <div
            ...
            <div class="flex items-start justify-between">
                <div>
                    ...
                    <SkeletonCard v-if="isLoading" />
                    <template v-else>
                        <h2 class="mt-2 text-3xl font-bold text-amber-400 dark:text-white">{{ totalPembelianHariIni }}</h2>
        ...
        <div
            ...
            <div class="flex items-start justify-between">
                <div>
                    ...
                    <SkeletonCard v-if="isLoading" />
                    <template v-else>
                        <h2 class="mt-2 text-3xl font-bold text-indigo-400 dark:text-white">{{ totalPelanggan }}</h2>
                        <p class="mt-3 text-xs text-slate-400">Customer terdaftar</p>
                    </template>
                </div>
                <div class="w-14 h-14 rounded-2xl bg-indigo-400 flex items-center justify-center">
