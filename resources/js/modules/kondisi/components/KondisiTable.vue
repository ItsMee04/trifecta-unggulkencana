<template>
    <div
        ...
        <div class="p-5 border-b border-slate-100 dark:border-slate-800 flex items-center justify-between gap-4">
            <h2 class="font-bold text-slate-900 dark:text-white text-base">Daftar Kondisi</h2>
        ...
        <div class="overflow-x-auto relative">
            ...
            <div v-if="isLoading && paginatedKondisi.length > 0"
            ...
            <table class="w-full text-left border-collapse table-fixed">
                <thead>
                    <tr
                        ...
                        <th class="py-3 px-4 w-[55%]">Kondisi</th>
                ...
                <tbody class="divide-y divide-slate-100 dark:divide-slate-800 text-sm">
                    ...
                    <tr v-if="isLoading && paginatedKondisi.length === 0">
