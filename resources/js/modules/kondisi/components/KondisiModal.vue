        ...
        <div class="flex min-h-full items-center justify-center p-4 text-center">
            ...
            <Transition appear enter-active-class="ease-out duration-300"
                ...
                <div v-show="isModalOpen"
                    ...
                    <form @submit.prevent="submitKondisi" class="p-6 space-y-4 font-sans">
                        <div class="space-y-1.5">
                            <label for="kondisi" class="text-sm font-medium text-slate-900 dark:text-slate-200 mb-3 block">
                                Kondisi
                            </label>
...
const { isModalOpen, isEdit, formKondisi, errors, isLoading, submitKondisi, closeModal } = useKondisi();
</script>
