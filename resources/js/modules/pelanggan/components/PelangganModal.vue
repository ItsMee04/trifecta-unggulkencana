                    ...
                    <form @submit.prevent="submitPelanggan" class="p-6 space-y-4 font-sans">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <div class="space-y-1.5">
                                ...
                                <input v-model="formPelanggan.kontak" type="text" id="kontak" placeholder="e.g. 08..."
                                    class="w-full px-3.5 py-2 bg-white dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl text-sm focus:outline-none focus:border-indigo-500 dark:focus:border-indigo-600 text-slate-900 dark:text-white transition" />
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div class="space-y-1.5">
                                ...
                                <input v-model="formPelanggan.tanggal" type="date" id="tanggal"
                                ...
                                <span v-if="errors.tanggal" class="text-xs text-rose-500 font-medium block mt-1">
                                    {{ errors.tanggal }}
                                </span>
                            </div>
...
const { isModalOpen, isEdit, formPelanggan, errors, isLoading, submitPelanggan, closeModal } = usePelanggan();
</script>
