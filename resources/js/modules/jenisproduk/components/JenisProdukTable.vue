<template>
    <div
        ...
        <div
            ...
            <h2 class="font-bold text-slate-900 dark:text-white text-base">Daftar Jenis Produk</h2>
        ...
        <div class="w-full overflow-x-auto relative">
            ...
            <div v-if="isLoading && paginatedJenisProduk.length > 0"
            ...
            <table class="w-full text-left border-collapse min-w-[600px]">
                <thead>
                    <tr
                        ...
                        <th class="py-3 px-4 w-[42%]">Jenis</th>
                        <th class="py-3 px-4 w-[20%]">Urutan</th>
                ...
                <tbody class="divide-y divide-slate-100 dark:divide-slate-800 text-sm">
                    ...
                    <tr v-if="isLoading && paginatedJenisProduk.length === 0">
                        ...
                        <td class="py-3 px-4 font-medium text-slate-900 dark:text-slate-200 uppercase">
                            <div class="flex items-center gap-3">
                                <div class="relative w-9 h-9 flex-shrink-0">
                                    <img v-if="item.image"
                                         :src="`/storage/jenisproduk/image/${item.image}?t=${new Date().getTime()}`"
                                         alt="Avatar"
                                ...
                                <div class="flex flex-col min-w-0">
                                    <span class="truncate font-semibold text-slate-800 dark:text-slate-200">{{ item.jenis }}</span>
                                </div>
                            </div>
                        </td>
