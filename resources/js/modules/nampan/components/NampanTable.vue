<template>
    <div
        ...
        <div
            ...
            <h2 class="font-bold text-slate-900 dark:text-white text-base">Daftar Nampan</h2>
        ...
        <div class="w-full overflow-x-auto relative">
            ...
            <div v-if="isLoading && paginatedNampan.length > 0"
            ...
            <table class="w-full text-left border-collapse min-w-[600px]">
                <thead>
                    <tr
                        ...
                        <th class="py-3 px-4 w-[30%] whitespace-nowrap">Nampan</th>
                        <th class="py-3 px-4 w-[30%] whitespace-nowrap">Jenis Produk</th>
