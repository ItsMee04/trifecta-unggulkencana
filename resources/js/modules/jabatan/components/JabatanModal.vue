        ...
        <div class="flex min-h-full items-center justify-center p-4 text-center">
            ...
            <Transition appear enter-active-class="ease-out duration-300"
                ...
                <div v-show="isModalOpen"
                    ...
                    <form @submit.prevent="submitJabatan" class="p-6 space-y-4 font-sans">
                        <div class="space-y-1.5">
                            <label for="nama_jabatan" class="text-sm font-medium text-slate-900 dark:text-slate-200 mb-3 block">
                                Nama Jabatan
                            </label>
                            <input v-model="formJabatan.jabatan" type="text" id="nama_jabatan"
                                placeholder="Jabatan"
                            ...
                            <span v-if="errors.jabatan" class="text-xs text-rose-500 font-medium block mt-1">
                                {{ errors.jabatan }}
                            </span>
                        </div>
...
const { isModalOpen, isEdit, formJabatan, errors, isLoading, submitJabatan, closeModal } = useJabatan();
</script>
