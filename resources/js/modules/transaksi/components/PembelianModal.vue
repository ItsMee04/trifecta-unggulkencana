                ...
                <div v-show="isNotaModalOpen"
                    ...
                    <div class="p-6 space-y-4 font-sans">
                        ...
                        <div v-else-if="selectedNotaData"
                            class="w-[21cm] h-[11cm] mx-auto bg-white p-5 text-[10px] text-slate-800 border border-slate-200 rounded-xl flex flex-col justify-between">
                                    ...
                                    <thead class="w-full">
                                        <tr
                                            ...
                                            <th
                                                ...
                                                Foto Produk</th>
                                            <th
                                                class="border-r border-slate-300 py-1.5 w-[42%] text-left px-3 flex items-center">
                                                Uraian Produk</th>
                                            <th
                                                class="border-r border-slate-300 py-1.5 w-[11%] flex items-center justify-center">
                                                Berat</th>
                                            <th
                                                class="border-r border-slate-300 py-1.5 w-[11%] flex items-center justify-center">
                                                Karat</th>
                                            <th
                                                ...
                                                Harga Beli</th>
                                            <th class="py-1.5 w-[10%] text-right pr-3 flex items-center justify-end">
                                                Total</th>
                                        </tr>
                                    </thead>
                                    <tbody class="flex-grow flex flex-col justify-start w-full overflow-y-auto">
                                        <tr v-for="(item, index) in selectedNotaData.items" :key="index"
                                            ...
                                            <td
                                                ...
                                                <img v-if="item.image" :src="dapatkanUrlFotoProduk(item.image)"
                                                    alt="Produk"
                            ...
                            <div class="grid grid-cols-12 gap-3 items-end border-t border-slate-200 pt-2">
                                <div class="col-span-5 text-[7px] text-slate-500 space-y-0.5 self-start">
                                    ...
                                    <div
                                        ...
                                        ID: <span class="font-bold">{{ generateHash(selectedNotaData.kode) }}</span>
                                    </div>
                                </div>
                                    ...
                                    <div class="grid grid-cols-12 items-center gap-2">
                                        <div class="col-span-6 text-center">
                                            ...
                                            <p
                                                ...
                                                {{ selectedNotaData.namapegawai || 'ADMIN' }}</p>
                                        </div>
                                        ...
                                        <div class="col-span-6 text-right">
                                            ...
                                            <span
                                                ...
                                                formatRupiah(selectedNotaData.total) }}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
import { usePembelian } from '../composables/usePembelian';
...
// Method untuk membuka CetakNotaTransaksi di tab baru
const cetakKeTabBaru = () => {
    if (!selectedNotaData.value?.kode) return;

    try {
        const routeData = router.resolve({
            name: 'CetakNotaPembelianDariToko',
            params: { kodeTransaksi: selectedNotaData.value.kode }
        });
