<template>
    <main class="relative p-3 sm:p-5 lg:p-6 font-sans bg-slate-50 dark:bg-slate-950 min-h-screen flex flex-col gap-4">
        ...
        >
            ...
            >
                <div class="bg-white dark:bg-slate-900 p-6 rounded-2xl shadow-2xl border border-slate-100 dark:border-slate-800 flex flex-col items-center gap-4 max-w-xs text-center">
                    <!-- Loading Spinner Ring -->
                    <div class="relative w-12 h-12">
                        <div class="w-12 h-12 border-4 border-blue-950/20 dark:border-white/20 border-t-blue-950 dark:border-t-white rounded-full animate-spin"></div>
                    </div>
